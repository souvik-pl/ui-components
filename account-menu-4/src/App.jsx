...
Menu.Content = ({ children }) => {
  ...
  useEffect(() => {
    ...
    let bottom = triggerRect.bottom + window.scrollY;
    ...
    let posY = "down";
    if (bottom + contentRect.height > window.innerHeight + window.scrollY) {
      posY = "up";
    }
    ...
    setContentPosition({
      ...
      y:
        posY === "down"
          ? bottom
          : bottom - triggerRect.height - contentRect.height,
    });
